...
{
    /**
     * Города вылета — идентификаторы Tourvisor (list.php?type=departure).
     * Из городов Кыргызстана справочник отдаёт только Бишкек; российский
     * список оставлен как есть — это вылеты из соседней страны.
     *
