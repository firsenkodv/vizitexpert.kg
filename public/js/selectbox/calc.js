...
$(document).ready(function () {
     ...
     * */
        ...
        $('body').on('click', '.mod_axeld_credit_192 .mod_axeld_credit__start', function (event) {
            ...
            $('.m_a_c__platej').text(new Intl.NumberFormat('ru-RU').format( platej ) + ' сом');
            $('.m_a_c__pereplata').text(new Intl.NumberFormat('ru-RU').format( vuplata ) + ' сом');
            $('.m_a_c__vuplata').text(new Intl.NumberFormat('ru-RU').format(Math.round(Price * Koff) * Mouth) + ' сом');
            $('.m_a_c__price').text(new Intl.NumberFormat('ru-RU').format(Price) + ' сом'); // только для mod_axeld_form
            ...
            $('input[name="monthly_payment"]').val(new Intl.NumberFormat('ru-RU').format( platej ) + ' сом');
            $('input[name="overpayment"]').val(new Intl.NumberFormat('ru-RU').format( vuplata ) + ' сом');
            $('input[name="total_payout"]').val(new Intl.NumberFormat('ru-RU').format(Price) + ' сом');
