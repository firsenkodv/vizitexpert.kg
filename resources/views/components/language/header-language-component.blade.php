{{-- Переключатель языков Google Website Translator.
     Разметка общая с другими проектами группы; клики ловит делегированием
     public/js/language/google-translate.js, активный пункт помечается
